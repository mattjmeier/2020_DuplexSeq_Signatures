...
nmdsplot <- ggplot(ord_plot_mutations, aes(x=MDS1,y=MDS2)) +
  ...
  theme_bw() +
  coord_fixed() +
  scale_shape(name = "Number of C/Gs in\ntarget sequence", labels=c("0","1","2","3")) +
...
```{r combine_results}
<<convert_to_wide>>
tnp_all <- trinucleotide_frequencies_proportions
dist_all <- vegdist(tnp_all, method="binomial")
<<main_analysis>>
pdf("./NMDS_binomial_all.pdf", width=11, height=5)
print(nmdsplot)
dev.off()
<<shrunken_centroid>>
```
...
```{r combine_results2}
<<convert_to_wide>>
tnp_intergenic <- trinucleotide_frequencies_proportions
dist_intergenic <- vegdist(tnp_intergenic, method="binomial")
<<main_analysis>>
pdf("./NMDS_binomial_intergenic.pdf", width=11, height=5)
print(nmdsplot)
dev.off()
```
...
<<main_analysis>>
pdf("./NMDS_binomial_genic.pdf", width=11, height=5)
print(nmdsplot)
dev.off()
```
